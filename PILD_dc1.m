...
load D:\highimbalance\ijcnn2001\train.txt;
load D:\highimbalance\ijcnn2001\ntr.txt;
dim=size(train,2)-2;
%dim=8;
sign0=[];
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\basicdata_train.txt','w');
...
for r=1:c-1,
    for t=r+1:c,
        ...
        d=d0;
        a0=[];
        a0(:,2:dim+1)=train(ntr(r,1):ntr(r,2),1:dim);
        ...
        a0(p0+1:p0+q0,2:dim+1)=train(ntr(t,1):ntr(t,2),1:dim);        
        if q0==1
...
%%/////////////////////////////////////////////////////////////////////////////////////////////
         ...
         fprintf(fid,'runtime(%d,%d)=%g\n',r,t,t1);
%///////////////////////////////////////////////////////////////////////////////////
         if (aver_index(3)>0.0001)&(((ir>99)&(numtr_0(3)<=numtr_0(2))&(numtr_0(2)<=numtr_0(1)))|(ir<=99))
...
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\w0.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w2');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\theta0.txt','w');
    fprintf(fid,'%.8f\n',theta2');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\w.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w4');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\theta.txt','w');
    fprintf(fid,'%.8f\n',theta4');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\w1.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w6');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\theta1.txt','w');
    fprintf(fid,'%.8f\n',theta6');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\w2.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w8');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\theta2.txt','w');
    fprintf(fid,'%.8f\n',theta8');
fclose(fid);
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\sign0.txt','w');
    fprintf(fid,'%g\n',sign0');
fclose(fid);
...
load D:\highimbalance\ijcnn2001\train.txt;
load D:\highimbalance\ijcnn2001\ntr.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w0.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w1.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w2.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\theta0.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\theta.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\theta1.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\theta2.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\sign0.txt;
...
for r=1:c-1,
    for t=r+1:c,
        ...
        p0=ntr(r,3);
        q0=ntr(t,3);
        a=train(ntr(r,1):ntr(r,2),1:dim);
        a(p0+1:p0+q0,:)=train(ntr(t,1):ntr(t,2),1:dim);
...
% AUC
        ...
        area_train(r,t)=0;
        for i=2:p0+q0+1,
            area_train(r,t)=area_train(r,t)+b(i,2)*(b(i,1)-b(i-1,1));
        end
        area_train(r,t);
...
%        fprintf(fid,'(r,t)=%d\n',r,t);
        ...
        err_train(r,t-1)=100*(1-(numtr0(1)+numtr0(2))/(p0+q0));
        err_train(r,c+t-2)=100*((p0-numtr0(1))/p0+(q0-numtr0(2))/q0)/2;
        err_train(r,2*c+t-3)=100*sqrt(((p0-numtr0(1))/p0)*((q0-numtr0(2))/q0));
        err_train(r,3*c+t-4)=100*area_train(r,t);
        err_train(r,4*c+t-5)=(err_train(r,t-1)+err_train(r,c+t-2)+err_train(r,2*c+t-3)+area_train(r,t)*100)/4;
    end
end

err_train
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\err_train.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test set.
load D:\highimbalance\ijcnn2001\test.txt;
load D:\highimbalance\ijcnn2001\nte.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w0.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w.txt;
load D:\highimbalance\ijcnn2001\inv_dc1\result\w1.txt;
...
for r=1:c-1,
    for t=r+1:c,
        ...
        p0=nte(r,3);
        q0=nte(t,3);
        a=test(nte(r,1):nte(r,2),1:dim);
        a(p0+1:p0+q0,:)=test(nte(t,1):nte(t,2),1:dim);
        re0=a*(w0(k,:))'+ones(p0+q0,1)*theta0(k);
        kk=sum(sign0(1:k));
        if sign0(k)==7
           re=a*(w(kk-6:kk,:))'+ones(p0+q0,1)*theta(kk-6:kk)';
...
% AUC
        ...
        area_test(r,t)=0;
        for i=2:p0+q0+1,
            area_test(r,t)=area_test(r,t)+b(i,2)*(b(i,1)-b(i-1,1));
        end
        area_test(r,t);
...
%        fprintf(fid,'(r,t)=%d\n',r,t);
        ...
        err_test(r,t-1)=100*(1-(numtr0(1)+numtr0(2))/(p0+q0));
        err_test(r,c+t-2)=100*((p0-numtr0(1))/p0+(q0-numtr0(2))/q0)/2;
        err_test(r,2*c+t-3)=100*sqrt(((p0-numtr0(1))/p0)*((q0-numtr0(2))/q0));
        err_test(r,3*c+t-4)=100*area_test(r,t);
        err_test(r,4*c+t-5)=(err_test(r,t-1)+err_test(r,c+t-2)+err_test(r,2*c+t-3)+area_test(r,t)*100)/4;
    end
end

err_test
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\err_test.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test');
fclose(fid);
...
% Majority vote for the training set
...
for i=1:n0,
    re0=train(i,1:dim)*w0'+theta0';
    re1=train(i,1:dim)*w'+theta';
    re2=train(i,1:dim)*w1'+theta1';
    re3=train(i,1:dim)*w2'+theta2';
    n00=0;
    for j=1:c-1,
        for k=j+1:c,
            n00=n00+1;
...
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\Number_error_train.txt','w');
    fprintf(fid,'\nFor the train set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
%clear all;
%t0=clock;
% Majority vote for the test set
...
for i=1:n0,
    re0=test(i,1:dim)*w0'+theta0';
    re1=test(i,1:dim)*w'+theta';
    re2=test(i,1:dim)*w1'+theta1';
    re3=test(i,1:dim)*w2'+theta2';
    n00=0;
    for j=1:c-1,
        for k=j+1:c,
            n00=n00+1;
...
fid=fopen('D:\highimbalance\ijcnn2001\inv_dc1\result\Number_error_test.txt','w');
    fprintf(fid,'\nFor the test set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
